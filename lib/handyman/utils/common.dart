...
import 'package:flutter_sixvalley_ecommerce/handyman/component/html_widget.dart';
import 'package:flutter_sixvalley_ecommerce/handyman/component/location_service_dialog.dart';
import 'package:flutter_sixvalley_ecommerce/handyman/component/new_update_dialog.dart';
...
import 'package:flutter_sixvalley_ecommerce/handyman/services/location_service.dart';
...
import 'package:flutter_sixvalley_ecommerce/handyman/utils/permissions.dart';
...
List<LanguageDataModel> languageList() {
  return [
    LanguageDataModel(id: 1, name: 'English', languageCode: 'en', fullLanguageCode: 'en-US', flag: 'assets_handyman/flag/ic_us.png'),
    LanguageDataModel(id: 2, name: 'Hindi', languageCode: 'hi', fullLanguageCode: 'hi-IN', flag: 'assets_handyman/flag/ic_india.png'),
    LanguageDataModel(id: 3, name: 'Arabic', languageCode: 'ar', fullLanguageCode: 'ar-AR', flag: 'assets_handyman/flag/ic_ar.png'),
    LanguageDataModel(id: 4, name: 'French', languageCode: 'fr', fullLanguageCode: 'fr-FR', flag: 'assets_handyman/flag/ic_fr.png'),
    LanguageDataModel(id: 5, name: 'German', languageCode: 'de', fullLanguageCode: 'de-DE', flag: 'assets_handyman/flag/ic_de.png'),
  ];
}
