                    ...
                    Marquee(
                      child: Row(
                        ...
                        children: [
                          ...
                          8.width,
                          Text(
                            DateFormat('MMMM d, yyyy').format(DateTime.parse(widget.data.createdAt.validate())),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              "${widget.forProvider
                                  ? widget.data.providersServiceRating.validate().toStringAsPrecision(1)
                                  : widget.data.handymanRating.validate().toStringAsFixed(1)}",
                              style: secondaryTextStyle(size: 12, weight: FontWeight.bold),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            Text("${language.booking}:", style: secondaryTextStyle(size: 12, weight: FontWeight.bold)),
                            2.width,
                            Text(
