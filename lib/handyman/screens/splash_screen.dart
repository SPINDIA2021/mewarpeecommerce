...
import 'package:flutter_sixvalley_ecommerce/handyman/screens/maintenance_mode_screen.dart';
...
log("*******");
    ...
    if (!getBoolAsync(IS_APP_CONFIGURATION_SYNCED_AT_LEAST_ONCE , defaultValue: true)) {
      appNotSynced = true;
      setState(() {});
      log("______");
    }
