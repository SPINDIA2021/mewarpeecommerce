...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/functions/notifications.dart';
...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/translations/translation.dart';
...
//pick image from camera
  ...
  List landings = [
    ...
    {
      'heading': 'SUPPORT',
      'text': 'Embark on your journey with confidence, knowing that our commitment to your satisfaction is unwavering'
    },
  ];
                                        ...
                                        .map((k, value) => MapEntry(
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    color: (currentPage == k) ? theme : Colors.grey),
                                              ),
                                            ))
                                        .values
                                        .toList(),
                                ...
                                child: Column(
                                  children: [
                                    AnimatedCrossFade(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        ...
                                                        image: (proImageFile1 == null)
                                                            ? const DecorationImage(
                                                                image: AssetImage(
                                                                  'assets_user_app/images/default-profile-picture.jpeg',
                                                                ),
                                                                fit: BoxFit.cover)
                                                            : DecorationImage(
                                        ...
                                        crossFadeState:
                                            (signIn == 0) ? CrossFadeState.showFirst : CrossFadeState.showSecond,
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: TextField(
                                                ...
                                                onChanged: (v) {
                                                  ...
                                                  } else if (isLoginemail == false &&
                                                      regExp.hasMatch(_email.text) == false) {
                                                    setState(() {
                                                      isLoginemail = true;
                                                    });
                                                  }
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(8), color: Colors.white),
                                            padding:
                                                EdgeInsets.only(right: media.width * 0.025, left: media.width * 0.025),
                                            child: Row(
                                              children: [
                                                Expanded(
                                                  child: TextField(
                                                    ...
                                                    obscureText:
                                                        ((withOtp == false || signIn == 1) && showPassword == false)
                                                            ? true
                                                            : false,
                                                  ),
                                                ),
                                                if (withOtp == false || signIn == 1)
                                                  IconButton(
                                                      ...
                                                      icon: Icon(
                                                        ...
                                                        color: (showPassword == true) ? const Color(0xffFFD302) : null,
                                                      ))
                                              ],
                                            ),
                                          ),
                                                ...
                                                children: [
                                                  ...
                                                  IconButton(
                                                      ...
                                                      icon: Icon(
                                                        Icons.remove_red_eye_sharp,
                                                        color:
                                                            (showNewPassword == true) ? const Color(0xffFFD302) : null,
                                                      ))
                                                ],
                                              ),
                                            ),
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: TextField(
                                                  ...
                                                  keyboardType: TextInputType.number,
                                                  decoration: InputDecoration(
                                                      hintText: languages[choosenLanguage]['text_driver_otp'],
                                                      border: InputBorder.none),
                                                ),
                                              ),
                                            ],
                                    ...
                                    if (signIn == 0 && forgotPassword == false && isMobileOtpSignIn == true)
                                      Column(
                                        children: [
                                          SizedBox(
                                        ...
                                        children: [
                                          Container(
                                              ...
                                              constraints: BoxConstraints(
                                                  maxWidth: media.width * 0.9, minWidth: media.width * 0.5),
                                        ...
                                        onTap: () async {
                                          ...
                                          if (newPassword == true) {
                                            if (_newPassword.text.length >= 8) {
                                              var val =
                                                  await updatePassword(_email.text, _newPassword.text, isLoginemail);
                                              if (val == true) {
                                                withOtp = false;
                                                otpSent = false;
                                                _password.clear();
                                                    ...
                                                    if (isLoginemail == true) {
                                                      ...
                                                      if (isCheckFireBaseOTP == true) {
                                                        ...
                                                        var val = await validateSmsOtp(
                                                            (signIn == 1) ? _mobile.text : _email.text, _password.text);
                                                        if (val == 'success') {
                                                          var verify = await verifyUser(
                                                              _email.text, 0, '', '', withOtp, forgotPassword);
                                                          if (forgotPassword == true) {
                                                      ...
                                                      if (isCheckFireBaseOTP) {
                                                        ...
                                                        if (val.value == true) {
                                                          ...
                                                          RemoteNotification noti = const RemoteNotification(
                                                              title: 'Otp for Login',
                                                              body: 'Login to your account with test OTP 123456');
                                                        ...
                                                        var val = await sendOTPtoMobile(
                                                            (signIn == 1) ? _mobile.text : _email.text,
                                            ...
                                            if (mobileVerified == true) {
                                              ...
                                              if (email != _email.text) {
                                                val = await verifyUser(_mobile.text, 0, _password.text, _email.text,
                                                    withOtp, forgotPassword);
                                              } else {
                                                val = false;
                                              }
                                              if (val == false) {
                                                Navigator.push(context,
                                                    MaterialPageRoute(builder: (context) => const AggreementPage()));
                                              } else {
                                                _error = val;
                                              }
                                              ...
                                              if (_name.text.isNotEmpty &&
                                                ...
                                                if (regExp.hasMatch(_mobile.text) &&
                                                  ...
                                                  if (regex.hasMatch(_email.text)) {
                                                    ...
                                                    var verify = await verifyUser(
                                                        _mobile.text, 0, '', _email.text, withOtp, forgotPassword);
                                                    if (verify == false) {
                                                      if (isCheckFireBaseOTP) {
                                                        var val = await otpCall();
                                                        if (val.value == true) {
                                                ...
                                                if (val == false) {
                                                  if (phoneAuthCheck == true) {
                                                    if (isCheckFireBaseOTP == true) {
                                                      ...
                                                      var val = await validateSmsOtp(
                                                          (signIn == 1) ? _mobile.text : _email.text, _otp.text);
                                                      if (val == 'success') {
                                                      ...
                                                      if (isLoginemail == false) {
                                                        ...
                                                        if (regExp.hasMatch(_email.text) &&
                                                          ...
                                                          if (isCheckFireBaseOTP) {
                                                            ...
                                                            if (val.value == true) {
                                                              await phoneAuth(
                                                                  countries[phcode]['dial_code'] + _email.text);
                                                              phoneAuthCheck = true;
                                                              _resend = false;
                                                              otpSent = true;
                                                              resendTimer = 60;
