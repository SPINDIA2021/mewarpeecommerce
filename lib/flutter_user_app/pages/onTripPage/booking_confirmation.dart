...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/pages/onTripPage/bookingwidgets.dart';
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    if (state == AppLifecycleState.resumed) {
      if (isDarkTheme == true) {
        ...
        await rootBundle
            .loadString('assets_user_app/map_style_black.json')
            .then((value) {
          mapStyle = value;
        });
      }
...
//get location permission and location details
  getLocs() async {
    ...
    if (choosenTransportType == 0) {
      markerIcon = await getBytesFromAsset('assets_user_app/images/top-taxi.png', 40);
      pinLocationIcon = BitmapDescriptor.fromBytes(markerIcon);
      markerIcon2 = await getBytesFromAsset('assets_user_app/images/bike.png', 40);
                                                                    ...
                                                                    (k == 0 ||
                                                                        ...
                                                                        ? Column(
                                                                            children: [
                                                                              ...
                                                                              Container(
                                                                                decoration: BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: AssetImage((addressList[k].type == 'pickup') ? 'assets_user_app/images/pick_icon.png' : 'assets_user_app/images/drop_icon.png'), fit: BoxFit.contain)),
                                                                                            ...
                                                                                            child: Row(
                                                                                              children: [
                                                                                                (etaDetails[choosenVehicle]['payment_type'].toString().split(',').toList()[payingVia] == 'cash')
                                                                                                    ? Image.asset(
                                                                                                        'assets_user_app/images/cash.png',
                                                                                                        width: media.width * 0.07,
                                                                                                    ...
                                                                                                    : (etaDetails[choosenVehicle]['payment_type'].toString().split(',').toList()[payingVia] == 'wallet')
                                                                                                        ? Image.asset(
                                                                                                            'assets_user_app/images/wallet.png',
                                                                                                            width: media.width * 0.07,
                                                                                                        ...
                                                                                                        : (etaDetails[choosenVehicle]['payment_type'].toString().split(',').toList()[payingVia] == 'card')
                                                                                                            ? Image.asset(
                                                                                                                'assets_user_app/images/card.png',
                                                                                                                width: media.width * 0.07,
                                                                                                                height: media.width * 0.07,
                                                                                                                fit: BoxFit.contain,
                                                                                                              )
                                                                                                            : (etaDetails[choosenVehicle]['payment_type'].toString().split(',').toList()[payingVia] == 'upi')
                                                                                                                ? Image.asset(
                                                                                                                    'assets_user_app/images/upi.png',
                                                                                                                    width: media.width * 0.07,
                                                                                                                    height: media.width * 0.07,
                                                                                                                    fit: BoxFit.contain,
                                                                                                                  )
                                                                                        ...
                                                                                        child: Row(
                                                                                          children: [
                                                                                            SizedBox(
                                                                                              ...
                                                                                              child: Image.asset(
                                                                                                'assets_user_app/images/Tune.png',
                                                                                                color: textColor,
                                                                                              ),
                                                                                            ),
                                                                                            MyText(
                                                                                            ...
                                                                                            child: (!confirmRideLater)
                                                                                                ? Container(
                                                                                                    ...
                                                                                                    child: (confirmRideLater == false)
                                                                                                        ? Image.asset(
                                                                                                            'assets_user_app/images/ride_later.png',
                                                                                                            color: textColor,
                                                                                                          )
                                                                                                        : MyText(
                                                                ...
                                                                children: [
                                                                  SizedBox(
                                                                    width: media
                                                                        ...
                                                                        0.06,
                                                                    child: Image.asset(
                                                                        'assets_user_app/images/promocode.png',
                                                                        fit: BoxFit
                                                                            .contain),
                                                                  ),
                                                                  SizedBox(
                                                      ...
                                                      child: Image.asset(
                                                        (userDetails['is_delivery_app'] !=
                                                                ...
                                                                userDetails[
                                                                        'is_delivery_app'] ==
                                                                    true)
                                                            ? 'assets_user_app/images/ridesearching_delivery.png'
                                                            : 'assets_user_app/images/ridesearching.png',
                                                        fit: BoxFit.contain,
                                                      ),
                                                    ),
                                                    SizedBox(
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Image
                                                                        .asset(
                                                                      'assets_user_app/images/call.png',
                                                                      color: const Color(
                                                                          0xff5BDD0A),
                                                                      height: media
                                                                              .width *
                                                                  ...
                                                                  (userRequestData[
                                                                      ...
                                                                      ? InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Image.asset(
                                                                                'assets_user_app/images/cancelimage.png',
                                                                ...
                                                                (i ==
                                                                    ...
                                                                    ? Column(
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            decoration:
                                                                                const BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: AssetImage('assets_user_app/images/drop_icon.png'), fit: BoxFit.contain)),
