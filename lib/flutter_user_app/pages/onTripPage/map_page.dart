...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/pages/onTripPage/pick_loc_select.dart';
...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/pages/onTripPage/ongoingrides.dart';
...
// dynamic _currentCenter;
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    if (isDarkTheme == true) {
      await rootBundle.loadString('assets_user_app/dark.json').then((value) {
        mapStyle = value;
      });
    } else {
      await rootBundle.loadString('assets_user_app/map_style_black.json').then((value) {
        mapStyle = value;
      });
    }
...
//get location permission and location details
  getLocs() async {
    ...
    final Uint8List markerIcon =
        await getBytesFromAsset('assets_user_app/images/top-taxi.png', 40);
    pinLocationIcon = BitmapDescriptor.fromBytes(markerIcon);
    final Uint8List deliveryIcons =
        await getBytesFromAsset('assets_user_app/images/deliveryicon.png', 40);
    deliveryIcon = BitmapDescriptor.fromBytes(deliveryIcons);
    final Uint8List bikeIcons =
        await getBytesFromAsset('assets_user_app/images/bike.png', 40);
                                                ...
                                                Expanded(
                                                  ...
                                                  children: [
                                                    SizedBox(
                                                      ...
                                                      child: Image.asset(
                                                        'assets_user_app/images/allow_location_permission.png',
                                                        fit: BoxFit.contain,
                                                      ),
                                                    ),
                                                    SizedBox(
                                                                              ...
                                                                              child: RotationTransition(
                                                                                ...
                                                                                child: Image.asset(
                                                                                  (myMarkers[k].markerId.toString().replaceAll('MarkerId(', '').replaceAll(')', '').split('#')[2].toString() == 'taxi')
                                                                                      ? 'assets_user_app/images/top-taxi.png'
                                                                                      : (myMarkers[k].markerId.toString().replaceAll('MarkerId(', '').replaceAll(')', '').split('#')[2].toString() == 'truck')
                                                                                          ? 'assets_user_app/images/deliveryicon.png'
                                                                                          : 'assets_user_app/images/bike.png',
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          ),
                                                          ...
                                                          child: (_dropLocationMap ==
                                                              ...
                                                              ? Column(
                                                                  children: [
                                                                    ...
                                                                    Image.asset(
                                                                      'assets_user_app/images/pick_icon.png',
                                                                      width: media
                                                                              .width *
                                                                          0.07,
                                                                      height: media
                                                              ...
                                                              : Image.asset(
                                                                  'assets_user_app/images/dropmarker.png'))),
                                                  (contactus == true)
                                                      ? Positioned(
                                                          right: 10,
                                                          top: 120 +
                                                            ...
                                                            child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  image: const DecorationImage(
                                                                      image: AssetImage(
                                                                          'assets_user_app/images/Rectangle.png')),
                                                                  borderRadius:
                                                                  ...
                                                                  Expanded(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                            .asset(
                                                                          'assets_user_app/images/taxia.png',
                                                                        ),
                                                                      ),
                                                                      // ),
                                                                    ),
                                                                                                        ...
                                                                                                        Positioned(
                                                                                                            ...
                                                                                                            child: AnimatedContainer(
                                                                                                              ...
                                                                                                              child: (isDarkTheme == true)
                                                                                                                  ? Image.asset(
                                                                                                                      // 'assets_user_app/images/delivery_main.png',
                                                                                                                      'assets_user_app/images/choose_vehicle_dark.png',
                                                                                                                      fit: BoxFit.fill,
                                                                                                                    )
                                                                                                                  : Image.asset(
                                                                                                                      // 'assets_user_app/images/delivery_main.png',
                                                                                                                      'assets_user_app/images/choose_vehicle.png',
                                                                                                                      fit: BoxFit.fill,
                                                                                                                    ),
                                                                                                            )),
                                                                                                        Positioned(
                                                                                                            ...
                                                                                                            child: AnimatedContainer(
                                                                                                              ...
                                                                                                              duration: const Duration(milliseconds: 500),
                                                                                                              child: Image.asset(
                                                                                                                'assets_user_app/images/taxi_main.png',
                                                                                                                fit: BoxFit.fill,
                                                                                                              ),
                                                                                                            )),
                                                                                                        Container(
                                                                                                      ...
                                                                                                      children: [
                                                                                                        ...
                                                                                                        Positioned(
                                                                                                            ...
                                                                                                            child: AnimatedContainer(
                                                                                                              ...
                                                                                                              child: Image.asset(
                                                                                                                // 'assets_user_app/images/delivery_main.png',
                                                                                                                'assets_user_app/images/delivery_intercity.png',
                                                                                                                fit: BoxFit.fill,
                                                                                                              ),
                                                                                                            )),
                                                                                                        Container(
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Positioned(
                                                                                                        ...
                                                                                                        child: AnimatedContainer(
                                                                                                          ...
                                                                                                          duration: const Duration(milliseconds: 500),
                                                                                                          child: Image.asset(
                                                                                                            'assets_user_app/images/rental.png',
                                                                                                            fit: BoxFit.fill,
                                                                                                          ),
                                                                                                        )),
                                                                                                    Container(
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Positioned(
                                                                                                                  ...
                                                                                                                  child: AnimatedContainer(
                                                                                                                    ...
                                                                                                                    duration: const Duration(milliseconds: 500),
                                                                                                                    child: Image.asset(
                                                                                                                      'assets_user_app/images/Outstation.png',
                                                                                                                      // fit: BoxFit.fill,
                                                                                                                    ),
                                                                                                                  )),
                                                                                                              Container(
                                                                                            ...
                                                                                            Row(
                                                                                              children: [
                                                                                                InkWell(
                                                                                                  onTap: () {
                                                                                                    setState(() {
                                                                                                      if (userDetails['enable_modules_for_applications'] == 'taxi' || userDetails['enable_modules_for_applications'] == 'both') {
                                                                                                          ...
                                                                                                          child: Row(
                                                                                                            children: [
                                                                                                              SizedBox(
                                                                                                                ...
                                                                                                                child: Image.asset(
                                                                                                                  'assets_user_app/images/pickupmarker.png',
                                                                                                                ),
                                                                                                              ),
                                                                                                              SizedBox(
                                                                                                                                  ...
                                                                                                                                  children: [
                                                                                                                                    Container(
                                                                                                                                      ...
                                                                                                                                      child: (favAddress[i]['address_name'] == 'Home')
                                                                                                                                          ? Image.asset(
                                                                                                                                              'assets_user_app/images/home.png',
                                                                                                                                              color: page,
                                                                                                                                              width: media.width * 0.04,
                                                                                                                                            )
                                                                                                                                          : (favAddress[i]['address_name'] == 'Work')
                                                                                                                                              ? Image.asset(
                                                                                                                                                  'assets_user_app/images/briefcase.png',
                                                                                                                                                  color: page,
                                                                                                                                                  width: media.width * 0.04,
                                                                                                                                                )
                                                                                                                                              : Image.asset(
                                                                                                                                                  'assets_user_app/images/navigation.png',
                                                                                                                                                  color: page,
                                                                                                                                                  width: media.width * 0.04,
                                                                                                                                                ),
                                                                                                                                    ),
                                                ...
                                                ? Container(
                                                    ...
                                                    decoration:
                                                      ...
                                                      image: DecorationImage(
                                                          image: AssetImage(
                                                              // 'assets_user_app/images/delivery_main.png'
                                                              'assets_user_app/images/delivery_outstation.png')),
                                                    ),
                                                  )
                                                : Container(
                                                    height: media.width * 0.12,
                                                    ...
                                                    decoration:
                                                      ...
                                                      image: DecorationImage(
                                                          image: AssetImage(
                                                              // 'assets_user_app/images/delivery_main.png'
                                                              'assets_user_app/images/delivery_package_ride.png')),
                                                    ),
                                                  ),
                                            SizedBox(
                                              width: media.width * 0.02,
