...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/functions/functions.dart';
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/pages/NavigatorPages/historyoutstationdetails.dart';
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/pages/loadingPage/loading.dart';
...
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/styles/styles.dart';
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/translations/translation.dart';
import 'package:flutter_sixvalley_ecommerce/flutter_user_app/widgets/widgets.dart';
                                                                        ...
                                                                        children: [
                                                                          (outStationList[i]['driverDetail'] != null)
                                                                              ...
                                                                              : Container(
                                                                                  height: media.width * 0.1,
                                                                                  width: media.width * 0.1,
                                                                                  decoration: const BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: AssetImage('assets_user_app/images/driver.png'), fit: BoxFit.cover)),
                                                                                ),
                                                                          SizedBox(
                                                                            width:
                                                                                media.width * 0.03,
                                                ...
                                                decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                        image: AssetImage((isDarkTheme)
                                                            ? 'assets_user_app/images/nodatafounddark.gif'
                                                            : 'assets_user_app/images/nodatafound.gif'),
                                                        fit: BoxFit.contain)),
                                              ),
                                              SizedBox(
                                                width: media.width * 0.6,
