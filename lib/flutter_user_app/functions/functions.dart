...
//base url
String url = 'https://mewarpe.com/rental/public/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
    (platform == TargetPlatform.android) ? 'AIzaSyBQwmZKiQAVzJUyy8ptro4O8kiekygB0oM' : 'AIzaSyBQwmZKiQAVzJUyy8ptro4O8kiekygB0oM';
  ...
  try {
    ...
    if (pref.containsKey('isDarkTheme')) {
      ...
      boxshadow = BoxShadow(
          blurRadius: 2, color: textColor.withOpacity(0.2), spreadRadius: 2);
      if (isDarkTheme == true) {
        mapStyle = await rootBundle.loadString('assets_user_app/dark.json');
      } else {
        mapStyle = await rootBundle.loadString('assets_user_app/map_style_black.json');
      }
    }
