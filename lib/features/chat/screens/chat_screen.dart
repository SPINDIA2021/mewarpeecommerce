                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ((chatProvider.pickedImageFileStored!=null && chatProvider.pickedImageFileStored!.isNotEmpty)  || (chatProvider.objFile != null && chatProvider.objFile!.isNotEmpty)) ?
                        ...
                        chatProvider.objFile != null && chatProvider.objFile!.isNotEmpty && chatProvider.isLoading == false ?
                        Padding(
                            ...
                            children: [
                              SizedBox(height: 70,
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index){
                                    String fileSize =  ImageSize.getFileSizeFromPlatformFileToString(chatProvider.objFile![index]);
                                    return Container(width: 180,
                                      ...
                                      child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                                        ...
                                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                                          ...
                                          Text(chatProvider.objFile![index].name,
                    ...
                    SizedBox(height: 250,
                      child: EmojiPicker(
                        ...
                        config: Config(
                          ...
                          emojiSet: getDefaultEmojiLocale, // Assuming this is already a constant or predefined value
                          locale: const Locale('en'),
                          emojiTextStyle: TextStyle(fontSize: 16, color: Colors.black), // You can set this based on your needs
                          customBackspaceIcon: Icon(Icons.backspace, color: Colors.blue), // Assuming you can use this
                          customSearchIcon: Icon(Icons.search, color: Colors.blue), // Assuming you can use this
                          viewOrderConfig: const ViewOrderConfig(),
                          emojiViewConfig: EmojiViewConfig(
                            columns: 7,
                            emojiSizeMax: 32 * (foundation.defaultTargetPlatform == TargetPlatform.iOS ? 1.30 : 1.0), // Cannot use dynamic expression here, handle outside of const
                            verticalSpacing: 0,
                            horizontalSpacing: 0,
                            gridPadding: EdgeInsets.zero,
                            // bgColor: const Color(0xFFF2F2F2),
