...
import 'package:flutter_sixvalley_ecommerce/eclassify/Ui/screens/main_activity.dart';
import 'package:flutter_sixvalley_ecommerce/eclassify/Utils/hive_keys.dart';
...
import 'package:flutter_sixvalley_ecommerce/eclassify/data/cubits/seller/fetch_verification_request_cubit.dart';
...
import 'package:flutter_sixvalley_ecommerce/eclassify/data/model/system_settings_model.dart';
...
import 'package:flutter_sixvalley_ecommerce/eclassify/Utils/Network/apiCallTrigger.dart';
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      ...
                                      // Control max lines based on expanded state
                                      softWrap: true,
                                      overflow: isExpanded
                                          ? TextOverflow.visible
                                          : TextOverflow.ellipsis,
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Text(
                                      ...
                                      /* SizedBox(
                              width: context.screenWidth * 0.63.rw(context),
                              child: Text("${state.data.rejectionReason!}\t",
                                  maxLines: 2,
                                  softWrap: true,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
