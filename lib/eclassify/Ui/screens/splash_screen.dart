...
// import 'package:flutter_sixvalley_ecommerce/eclassify/main.dart';
// import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_sixvalley_ecommerce/eclassify/Ui/screens/widgets/Errors/no_internet.dart';
...
import 'package:flutter_sixvalley_ecommerce/eclassify/data/Repositories/system_repository.dart';
// import 'package:flutter/services.dart';
...
/*  Future<void> locationPermission() async {
  ...
  void navigateToScreen() async {
    if (context.read<FetchSystemSettingsCubit>().getSetting(SystemSetting.maintenanceMode) == "1") {
      ...
      if ((HiveUtils.getUserDetails().name == null || HiveUtils.getUserDetails().name == "") || (HiveUtils.getUserDetails().email == null || HiveUtils.getUserDetails().email == "") || (HiveUtils.getUserDetails().mobile == null || HiveUtils.getUserDetails().mobile == "")) {
        Future.delayed(
                  ...
                  body: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Text(AppSettings.applicationName).size(context.font.xxLarge).color(context.color.secondaryColor).centerAlign().bold(weight: FontWeight.w600),
