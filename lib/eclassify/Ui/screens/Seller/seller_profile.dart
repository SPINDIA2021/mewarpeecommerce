...
import 'package:flutter_sixvalley_ecommerce/eclassify/data/model/seller_ratings_model.dart';
...
class SellerProfileScreenState extends State<SellerProfileScreen>
  ...
  void dispose() {
    ...
    controller.dispose();
    reviewController.removeListener(_loadMore);
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildReviewCard(ratings);
                  },
                ),
              ),
              if (state.isLoadingMore) UiUtils.progress()
